...
class RegressionTests(unittest.TestCase):
  ...
  def test_desktop_defaults(self):
    ...
    self.assertEqual(bar["backlight"]["format"], "")
    self.assertEqual(bar["pulseaudio"]["format"], "{icon}")
    self.assertEqual(bar["pulseaudio"]["format-bluetooth"], "{icon}")
    self.assertEqual(bar["pulseaudio"]["format-source"], "")
